...
index = create_or_load_index("embedded_index_v16", index_key_path="models/cyborg_indexes/embedded_index_v16.key", embedding_model=os.environ.get("CYBORG_EMBEDDING_MODEL", "all-MiniLM-L6-v2"))
