...
class ForecastGenerator:
    ...
    def _get_latest_date(meta, date_column='date'):
        ...
        if latest_str is None:
            latest_str = meta.get('train_end')
        if latest_str is None:
            raise ValueError("Metadata is missing date information ('data_end' and 'train_end'). Please retrain the model.")
        ...
        try:
            ...
            raise ValueError(f"Cannot parse date '{latest_str}' from metadata: {e}")
