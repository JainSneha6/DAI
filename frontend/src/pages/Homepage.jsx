...
export default function DecisivAIHomepage() {
  return (
    <div className="min-h-screen flex items-center justify-center bg-linear-to-br from-[#1b1f30] via-[#1a2238] to-[#111827] p-8 relative overflow-hidden">
      ...
      <div className="w-full max-w-5xl rounded-3xl shadow-[0_0_60px_-20px_rgba(0,0,0,0.6)] overflow-hidden relative border border-white/10 bg-linear-to-br from-[#0d111a]/60 to-[#0e1320]/40 backdrop-blur-xl p-16">
        <main className="flex flex-col items-center text-center relative z-10">
          ...
          <motion.a
            ...
            href="#get-started"
            className="inline-flex items-center gap-3 rounded-full px-8 py-3 bg-linear-to-r from-[#4c6ef5] to-[#7c3aed] text-white text-lg font-medium shadow-xl hover:opacity-95 focus:outline-none focus:ring-4 focus:ring-violet-700/40"
          >
            Get Started
            <ArrowRight size={18} />
          </motion.a>
